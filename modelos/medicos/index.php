...
if (!isset($_SESSION['idusuario'])) {
    ...
    $medicos  = "SELECT m.idmedico, m.nombremedico, m.curp, m.cedula, s.nombreservicio, m.diasconsulta, m.numpacientes, m.condicion FROM medicos m INNER JOIN servicios s ON m.idservicio=s.idservicio ORDER BY nombremedico ASC";
