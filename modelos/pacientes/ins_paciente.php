...
if (!isset($_SESSION['idusuario'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (count($campos) > 0) {
            ...
            if ($fila > 0) {
                header('location:../extend/alerta.php?msj=EL paciente con la CURP: ' . $curp . ' o el número de expediente:' .$expediente.' ya existe en la base de datos&c=pac&p=in&t=error');
            } else {
